window.UI_TRANSLATIONS_RU = {
  ...
  abilityAll: 'Все',
  noResults: 'Ничего не найдено. Попробуйте ослабить фильтры.',
  openFullInfo: 'Открыть полную информацию',
  dpsTooltip: 'DPS на уровне 1 и на 18 уровне',
  loadChampionsError: 'Не удалось загрузить список чемпионов из Data Dragon.',
  cacheLoaded: 'Данные загружены из кэша'
};
